...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "尝试次数": "Attempt Count",
  "尝试链路": "Attempt Trace",
  "当前仅 SOCKS5 与 HTTP CONNECT 记录建连切换链路。": "Only SOCKS5 and HTTP CONNECT currently record CONNECT failover traces.",
  "超时": "Timeout",
  "结果": "Result",
  "同 IP 替代": "Same-IP Retry",
  "时间": "Time",
  "开始时间": "Start Time",
  "结束时间": "End Time",
  "名称": "Name",
  ...
  "错误详情:": "Error Details:",
  "已取消": "Canceled",
  "CONNECT 建连失败": "CONNECT dial failed",
  "CONNECT 劫持连接失败": "CONNECT hijack failed",
  "CONNECT 成功响应写回客户端失败": "CONNECT success response write-back failed",
  "CONNECT 成功响应刷新到客户端失败": "CONNECT success response flush failed",
  "CONNECT 客户端预读缓冲区处理失败": "CONNECT client prefetch drain failed",
  "CONNECT 隧道下行复制失败": "CONNECT downstream copy failed",
  "CONNECT 隧道上行复制失败": "CONNECT upstream copy failed",
  "CONNECT 隧道无双向流量": "CONNECT tunnel had no bidirectional traffic",
  "CONNECT 隧道无下行流量": "CONNECT tunnel had no downstream traffic",
  "CONNECT 隧道无上行流量": "CONNECT tunnel had no upstream traffic",
  "SOCKS5 建连失败": "SOCKS5 dial failed",
  "SOCKS5 响应客户端失败": "SOCKS5 reply to client failed",
  "SOCKS5 隧道下行复制失败": "SOCKS5 downstream copy failed",
  "SOCKS5 隧道上行复制失败": "SOCKS5 upstream copy failed",
  "SOCKS5 隧道无双向流量": "SOCKS5 tunnel had no bidirectional traffic",
  "SOCKS5 隧道无下行流量": "SOCKS5 tunnel had no downstream traffic",
  "SOCKS5 隧道无上行流量": "SOCKS5 tunnel had no upstream traffic",
  "HTTP 正向代理请求上游失败": "HTTP forward-proxy upstream request failed",
  "反向代理请求上游失败": "Reverse-proxy upstream request failed",
